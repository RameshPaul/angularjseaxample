define(['angular'], function(angular){
    var registration = angular.module("Registration.Signup", ['angularFileUpload']);
    var URL =  {"base_url": '/tst_registration/index.php',"registrationURL": '/api/user', "registrationSuccess":'/appsignin', "uploadURL":'/api/user'};

    registration.controller("registrationCtrl", ['$scope', '$rootScope', '$http', 'FileUploader', '$state', function($scope, $rootScope, $http, FileUploader, $state){
