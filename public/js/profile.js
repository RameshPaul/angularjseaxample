(function(){
    var profile = angular.module("profile", ['angularFileUpload']);

    profile.controller("profileCtrl", ['$scope', '$rootScope', 'ProfileService', 'URL', 'FileUploader', function($scope, $rootScope, ProfileService, URL, FileUploader){
    ...
    profile.factory("ProfileService", ['$http', 'URL', function($http, URL){
        return{
    ...
    profile.value("URL", {"base_url": '/tst_registration/index.php',"base_dir": '/tst_registration/', "getProfileData": '/profile/profileinfo', "updateProfileData":'/profile/updateuserdata'});
})();